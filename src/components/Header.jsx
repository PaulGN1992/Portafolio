...
export default function Header() {
  ...
  return (
    <>
      ...
      <header className="border-b-1 relative top-0 left-0 z-20 w-full border-b border-slate-200 bg-white/90 shadow-lg shadow-slate-700/5 after:absolute after:top-full after:left-0 after:z-10 after:block after:h-px after:w-full after:bg-slate-200 lg:border-slate-200 lg:backdrop-blur-sm lg:after:hidden">
          ...
          >
            ...
            >
              <svg
                ...
                className="h-12 w-12 bg-teal-500"
              >
                <path
                  fillRule="evenodd"
                  clipRule="evenodd"
            ...
            >
              ...
              <li role="none" className="flex items-stretch">
                <a
                  ...
                  aria-current="page"
                  aria-haspopup="false"
                  className="flex items-center gap-2 py-4 text-teal-500 transition-colors duration-300 hover:text-teal-600 focus:text-teal-600 focus:outline-none focus-visible:outline-none lg:px-8"
                  href="/about"
                >
                  <span>Sobre Mi</span>
                </a>
